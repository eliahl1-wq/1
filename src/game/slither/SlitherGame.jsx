...
export default function SlitherGame() {
    ...
    useEffect(() => {
        ...
        document.body.style.backgroundColor = '#160924';
    ...
    return (
        <div style={{
            ...
            {(!isConnected || !gameReady) && (
                <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#160924', color: 'white', zIndex: 1000 }}>
            ...
            <div style={{ position: 'absolute', top: '30px', right: '30px', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '2px', zIndex: 100 }}>
                ...
                <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.8rem' }}>Slither Mode</div>
                ...
                <div style={{ fontSize: '0.82rem', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    {leaderboard.map((p, i) => (
                        <div key={p.id || i} style={{
                            ...
                            <span style={{ fontFamily: 'ui-monospace, monospace' }}>${(p.balance ?? 0).toFixed(2)}</span>
                        </div>
                    ))}
                </div>
            </div>
