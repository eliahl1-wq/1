...
export const MIN_ENTRY_FEE = Math.min(...COMPETITIVE_ENTRY_TIERS, ...SURVIV_ENTRY_TIERS, ...ENTRY_TIERS, ...BR_ENTRY_TIERS);
...
export function normalizeSurvivEntryFee(fee) {
    const n = Number(fee);
    return SURVIV_ENTRY_TIERS.includes(n) ? n : DEFAULT_SURVIV_ENTRY_FEE;
}
...
/** Surviv economy — $5 entry, $2 player start, $3 map loot pool. */
